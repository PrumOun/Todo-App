package com.example.todotasks.ui.pagertab.items
...
import com.example.todotasks.ui.pagertab.TaskItemLayout
        ...
        item(key) {
            Column(
                ...
                val lottieComposition by rememberLottieComposition(
                    spec = LottieCompositionSpec.RawRes(R.raw.task_done)
                )
                LottieAnimation(
